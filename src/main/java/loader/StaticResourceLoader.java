...
public class StaticResourceLoader {
    ...
    public static ResourceData loadResourceData(String path) throws IOException {
        ...
        if (resourceUrl == null) {
            resourceUrl = StaticResourceLoader.class.getClassLoader().getResource(BASE_PATH + DEFAULT_INDEX_PATH);
        }
