...
public class ResponseHandler {
    ...
    public void createResponse(Map<String, List<String>> requestMap, OutputStream out, Response response) {
    ...
    private void sendResponse(DataOutputStream dos, byte[] body, String header) {
        try {
